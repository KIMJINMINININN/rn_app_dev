  ...
  return (
    <section aria-label={`${dateLabel} 세션`} className="flex flex-col">
      ...
      <header className="mb-3 flex items-center justify-between gap-2">
        ...
        {/* TODO(F3): 세션 에디터(바텀시트/모달) 오픈. 지금은 비활성 스텁. */}
        <Button variant="secondary" size="sm" disabled title="세션 에디터(F3) 예정">
      ...
      {sessions.length > 0 ? (
        ...
        <EmptyState
          ...
          action={
            // TODO(F3): 세션 에디터 오픈. 지금은 비활성 스텁.
            <Button variant="primary" size="md" disabled title="세션 에디터(F3) 예정">
