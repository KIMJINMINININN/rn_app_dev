...
export function LoginForm() {
  ...
  return (
    <form action={formAction} className="space-y-20">
      ...
      {state.info ? (
        <div className="flex items-start gap-12 rounded-m border border-green-200 bg-green-100 px-16 py-12">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="currentColor"
            className="mt-2 h-16 w-16 shrink-0 text-green-600"
            aria-hidden="true"
          >
            <path
              fillRule="evenodd"
          ...
          <p className="text-body-xs-400 text-green-700">{state.info}</p>
        </div>
      ) : null}
